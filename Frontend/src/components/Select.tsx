      ...
      <div className="relative">
        <select
          ...
          className={twMerge(
            ...
            "rounded-lg bg-white dark:bg-zinc-800 outline-none text-[#BDBDBD] dark:text-white",
            "placeholder:text-secondary-solid cursor-pointer appearance-none",
            color === "secondary" &&
            `border-secondary-solid text-secondary-solid`,
            rest?.value && "text-black dark:text-white",
            selectClassName
          )}
          {...rest}
        >
        ...
        <ChevronDown
          className={twJoin(
            "absolute w-4 h-4 right-5 dark:text-white",
